...
create policy if not exists "Members can view room"
...
create policy if not exists "Authenticated can create rooms"
...
create policy if not exists "Users can view their memberships"
...
create policy if not exists "Users can leave rooms"
